...
export const FilterOptions = () => {
    ...
    return (
        <>
            <div className="block sm:block md:flex lg:flex xl:flex items-center w-full h-full">
                <div className="flex flex-wrap justify-start items-center w-auto h-20 sm:h-20 md:h-9 lg:h-9 xl:h-9">
                    <button className={
                        `
                        flex justify-center items-center w-auto h-9 px-2.5 text-base ${qFilter === 'offers' ? 'bg-[#191919] text-white hover:bg-[#191919] active:bg-[#191919]' : 'text-[#191919] bg-[#e7e7e7] active:bg-[#d6d6d6] hover:bg-[#f7f7f7]'} rounded-full font-bold overflow-hidden no-outline duration-100
                        `
                    ...
                    <button className={
                        `
                        flex justify-center items-center w-auto h-9 px-2.5 ml-1.5 sm:ml-1.5 md:ml-1.5 lg:ml-1.5 xl:ml-1.5 text-base ${qFilter === 'over_4.5' ? 'bg-[#191919] text-white hover:bg-[#191919] active:bg-[#191919]' : 'text-[#191919] bg-[#e7e7e7] active:bg-[#d6d6d6] hover:bg-[#f7f7f7]'} rounded-full font-bold overflow-hidden no-outline duration-100
                        `
                    ...
                    <button className={
                        `
                        flex justify-center items-center w-auto h-9 px-2.5 ml-0 sm:ml-0 md:ml-1 lg:ml-1 xl:ml-1 mt-1 sm:mt-1 md:mt-0 lg:mt-0 xl:mt-0 text-base ${qFilter === 'under_999' ? 'bg-[#191919] text-white hover:bg-[#191919] active:bg-[#191919] fill-[#191919]' : 'text-[#191919] bg-[#e7e7e7] active:bg-[#d6d6d6] hover:bg-[#f7f7f7] fill-[#e7e7e7]'} rounded-full font-bold overflow-hidden no-outline duration-100
                        `
                ...
                <div className="flex justify-start sm:justify-start md:justify-end lg:justify-end xl:justify-end items-center w-auto text-md font-medium text-[#797979]">
