                                ...
                                <div className="flex flex-col justify-start items-end w-full h-12">
                                    {(!(
                                        ...
                                        <div className="flex justify-start items-center w-full h-full leading-none text-xl sm:text-xl md:text-base lg:text-base xl:text-base font-medium">
                                            {!signinLoading ? <button className="flex justify-center items-center w-full h-full px-4 bg-[--global-button-color-default] hover:bg-[--global-button-color-hover] active:bg-[#064434] rounded-[--global-radius-md] text-white font-bold duration-75" type="submit">
                                                Continue to Sign in
                                            </button>
                                                :
